...
<kme3:page title="{{SocData.socPageTitle}}" toolName="academics" ngAppName="scheduleOfClassesApp" ngControllerName="ScheduleOfClassesController" ngInitFunction="init" backFunction="kmeNavLeft" cssFilename="academics" jsFilename="scheduleOfClasses, academics.i18n">
    <div id="theContentArea" class="main-view" ng-view="">
    </div>
    <script type="text/javascript" src="${pageContext.request.contextPath}/academics/js/academics.i18n.js"></script>
</kme3:page>
