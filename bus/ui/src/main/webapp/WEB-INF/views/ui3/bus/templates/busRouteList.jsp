...
<div ng-controller="BusRouteListController" ng-init="init()">
    ...
    <div class="list-group">
        <a href="#/stops" class="list-group-item" ng-click="busRouteClick(thisRoute)"
           ng-repeat="thisRoute in BusData.routes.busRoute">
            <span class="pull-right glyphicon glyphicon-chevron-right black right-decoration"></span>
            <img ng-src="${pageContext.request.contextPath}/images/bus-icons/bus-{{thisRoute.color | uppercase}}-36x36.png"/>
            {{thisRoute.name}}
        </a>
    </div>
    <bus-tabs></bus-tabs>
